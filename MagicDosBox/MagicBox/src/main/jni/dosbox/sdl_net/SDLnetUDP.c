...
{
//	__android_log_print(ANDROID_LOG_VERBOSE, "MagicBox", "ipxserver SDLNet_UDP_Open start");
...
//	__android_log_print(ANDROID_LOG_VERBOSE, "MagicBox", "ipxserver SDLNet_UDP_Open 1 ");

	/* Open the socket */
#ifdef MACOS_OPENTRANSPORT
	__android_log_print(ANDROID_LOG_VERBOSE, "MagicBox", "ipxserver SDLNet_UDP_Open 2 ");
	{
...
#else
	//__android_log_print(ANDROID_LOG_VERBOSE, "MagicBox", "ipxserver SDLNet_UDP_Open 3 ");
	...
	if ( port )
	{
		//__android_log_print(ANDROID_LOG_VERBOSE, "MagicBox", "ipx SDLNet_UDP_Open");
